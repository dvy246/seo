  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="prose-meta">
        <p>
          MetaForge is a free, all-in-one SEO studio for generating meta tags, social previews, JSON-LD structured data, and robots.txt — built by marketers and developers who got tired of bouncing between five different tools every time they published a new page.
        </p>
        ...
        <h2>What MetaForge does differently</h2>
        <p>
          MetaForge puts everything in one place. You enter your title once and see it update in the Google, Facebook, X, LinkedIn, Slack, and Discord previews simultaneously. You generate JSON-LD structured data right next to your meta tags. You build your robots.txt without leaving the studio. And you save a brand profile once, so every new page inherits your defaults.
        </p>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="prose-meta">
        ...
        <h2>Summary</h2>
        <p>
          MetaForge does not collect personal data. All data you enter into the tool — page setups, brand profiles, generated tags — is stored locally in your browser and never sent to our servers. We use privacy-friendly analytics to understand aggregate traffic patterns. Third-party advertising partners may use cookies as described below.
        </p>

        <h2>Data you enter</h2>
        <p>
          All data you enter into MetaForge — titles, descriptions, URLs, images, schema data, brand profile, saved page setups — is stored exclusively in your browser's local storage. It is never transmitted to our servers. Clearing your browser data will delete your saved setups and brand profile.
        </p>
        ...
        <h2>Advertising</h2>
        <p>
          MetaForge displays ads through third-party advertising partners (such as Google AdSense). These partners may use cookies to serve relevant ads. You can opt out of personalized advertising through your browser settings or the ad partner's opt-out tools. Ad partners may collect: cookie data, IP address (anonymized), browser type, device type, and pages visited on this site.
        </p>

        <h2>Cookies</h2>
        <p>
          MetaForge itself does not set tracking cookies. Third-party advertising and analytics partners may set cookies. You can control cookies through your browser settings.
        </p>
        ...
        <p>
          MetaForge is not directed at children under 13. We do not knowingly collect data from children.
        </p>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="prose-meta">
        ...
        <p>
          By using MetaForge, you agree to these terms. If you do not agree, do not use the tool.
        </p>

        <h2>The service</h2>
        <p>
          MetaForge is a free, browser-based tool for generating SEO meta tags, social previews, JSON-LD structured data, and robots.txt files. The tool runs entirely in your browser and does not require an account.
        </p>

        <h2>Accuracy of output</h2>
        <p>
          MetaForge generates meta tags, structured data, and previews based on the values you enter. While we strive for accuracy, the output is a starting point. Search engines and social platforms may render or interpret your tags differently. You are responsible for testing your tags with the appropriate tools (Google's Rich Results Test, platform debuggers) before and after publishing. We are not liable for how search engines or social platforms display your content.
        </p>

        <h2>Acceptable use</h2>
        <p>
          You agree not to use MetaForge to generate tags or structured data for pages that contain illegal content, malware, or content that violates applicable laws. You are responsible for the content you generate.
        </p>

        <h2>Intellectual property</h2>
        <p>
          The MetaForge tool, its design, and its code are the property of MetaForge. The output you generate — meta tags, JSON-LD, robots.txt — belongs to you and is free to use on your sites.
        </p>

        <h2>No warranty</h2>
        <p>
          MetaForge is provided "as is" without warranty of any kind. We do not guarantee that the tool will be error-free, uninterrupted, or that the generated output will result in specific search rankings or social preview appearances.
        </p>

        <h2>Limitation of liability</h2>
        <p>
          MetaForge is a free tool. We are not liable for any damages arising from the use or inability to use the tool, including but not limited to lost revenue, lost data, or business interruption.
        </p>

        <h2>Changes to terms</h2>
        <p>
          We may update these terms from time to time. Continued use of MetaForge after changes constitutes acceptance of the updated terms.
        </p>
      </div>
    </div>
  );
