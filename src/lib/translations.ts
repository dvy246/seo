...
const en: UITranslations = {
  ...
  heroBadge: 'All-in-one SEO, AEO & GEO studio',
  heroTitlePrefix: 'Set up your page SEO, AEO, and GEO in',
  heroTitleHighlight: 'one AI-powered place',
  heroTitleSuffix: '.',
  heroSubtitle:
...
const es: UITranslations = {
  ...
  heroBadge: 'Estudio de SEO, AEO y GEO todo en uno',
  heroTitlePrefix: 'Configura todo el SEO, AEO y GEO de tu página en',
  heroTitleHighlight: 'un solo lugar con IA',
  heroTitleSuffix: '.',
  heroSubtitle:
...
const fr: UITranslations = {
  ...
  heroBadge: 'Studio SEO, AEO et GEO tout-en-un',
  heroTitlePrefix: 'Configurez tout le SEO, AEO et GEO de votre page en',
  heroTitleHighlight: 'un seul endroit avec l\'IA',
  heroTitleSuffix: '.',
  heroSubtitle:
...
const de: UITranslations = {
  ...
  heroBadge: 'All-in-One SEO, AEO & GEO Studio',
  heroTitlePrefix: 'Richten Sie Ihr gesamtes Seiten-SEO, AEO und GEO an',
  heroTitleHighlight: 'einem KI-gestützten Ort ein',
  heroTitleSuffix: '.',
  heroSubtitle:
...
const pt: UITranslations = {
  ...
  heroBadge: 'Estúdio de SEO, AEO e GEO tudo em um',
  heroTitlePrefix: 'Configure todo o SEO, AEO e GEO da sua página em',
  heroTitleHighlight: 'um só lugar com IA',
  heroTitleSuffix: '.',
  heroSubtitle:
...
const ja: UITranslations = {
  ...
  openStudio: 'スタジオを開く',
  browseTools: 'ツールを見る',
  heroBadge: 'オールインワン SEO, AEO & GEO スタジオ',
  heroTitlePrefix: 'ページの SEO, AEO, GEO 設定をすべて',
  heroTitleHighlight: 'AI搭載の1か所で',
  heroTitleSuffix: '。',
  heroSubtitle:
